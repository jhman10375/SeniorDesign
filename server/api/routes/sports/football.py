...
from classes import Season, playerList
import pickle
...
@router.get("/teams/{team_name}/last_game", tags=["Team Info"])
...
@router.get("/teams/{team_name}/next_game", tags=["Team Info"])
...
@router.get("/teams/{team_name}/players", tags=["Team Info"])
...
@router.get("/players/search/by_name/{player_name}", tags=["Player Info"])
...
@router.get("/players/search/by_id/{player_id}", tags=["Player Info"])
async def search_for_players_by_id(player_id : int) -> playerInfo:

    return search_player(fullList, player_id)

@router.get("/players/search/by_ids", tags=["Player Info"])
...
@router.get("/players/getall", tags=["Player Info"])
...
@router.get("/players/get_first_string", tags=["Player Info"])
...
@router.get("/player/{player_id}/stats/full_year", tags=["Player Info"])
...
@router.get("/player/{player_id}/stats/last_game", tags=["Player Info"])
...
@router.get("/{team_name}/D-ST/stats/last_game", tags=["D/ST"])
...
@router.get("/{team_name}/D-ST/stats/full_season", tags=["D/ST"])
...
@router.get("/predict/{player_id}/game", tags=["Prediction"])
...
@router.get("/predict/season/{player_id}", tags=["Prediction"])
...
@router.get("/predict/D-ST/{team_name}", tags=["Prediction"])
...
@router.get("/predict/season/D-ST/{team_name}", tags=["Prediction"])
