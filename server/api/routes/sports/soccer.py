...
@router.get("/scc/teams/{team_name}", tags=["Soccer", "Soccer - Team Info"])
...
@router.get("/scc/teams/{team_name}/last_game", tags=["Soccer", "Soccer - Team Info"])
async def get_last_soccer_game(team_name: str) -> bbGame:
   return scc_last_game(team_name, sccList)


@router.get("/scc/teams/{team_name}/next_game", tags=["Soccer", "Soccer - Team Info"])
...
@router.get("/scc/teams/{team_name}/players", tags=["Soccer", "Soccer - Team Info"])
...
@router.get("/scc/players/search/by_name/{player_name}", tags=["Soccer", "Soccer - Player Info"])
...
@router.get("/scc/players/search/by_id/{player_id}", tags=["Soccer", "Soccer - Player Info"])
...
@router.get("/scc/players/getall", tags=["Soccer", "Soccer - Player Info"])
...
@router.get("/scc/player/{player_id}/stats/last_game", tags=["Soccer", "Soccer - Player Info"])
...
@router.get("/scc/player/{player_id}/stats/full_year", tags=["Soccer", "Soccer - Player Info"])
