...
from server.api.models.draft_player_stats.football_player import FootballPlayerStats
...
class DraftManager:
    def __init__(self):
        ...
        self.players: Dict[str, List[FootballPlayerStats]] = {}
    ...
    def generate_players(self, draft_key):
        ...
        self.players[draft_key] = list(map(lambda x: FootballPlayerStats(
            x.player_id,
            x.player_name,
            x.player_position,
            x.player_jersey,
