...
@Component({
  ...
  selector: 'new-basketball-league',
  templateUrl: 'new-basketball-league.component.html',
})
export class NewBasketballLeagueComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  basketballLeague: BasketballLeagueSettingsModel =
  ...
  goToLeague(): void {
    this.router.navigate([
      'league',
      (this.formGroup.getRawValue() as BasketballLeagueSettingsModel).LeagueID,
    ]);
  }
  ...
  onSubmit(): void {
    if (!this.formGroup.disabled) {
      ...
      console.log(
        this.formGroup.getRawValue() as BasketballLeagueSettingsModel
      );
      ...
      this.athleteService.players.pipe(take(1)).subscribe({
        next: (athletes) => {
          ...
          league.LeagueType = SportEnum.Basketball;
          league.Manager = (
            league.Settings as BasketballLeagueSettingsModel
          ...
          this.leagueToolsService
            .getLeagueSchedules(
              ...
              (league.Settings as BasketballLeagueSettingsModel).SeasonModel
  ...
  enablePositionModelValidation(): void {
    ...
    this.formGroup.get('PositionModel')?.get('GMax')?.markAsDirty();
    this.formGroup.get('PositionModel')?.get('GMax')?.updateValueAndValidity();
  }
  ...
  private buildBasketballLeague(): void {
    this.formGroup = this.fb.group({
      ID: [GeneralService.GenerateID()],
      LeagueID: [this.team.LeagueID],
      GeneralSettingsModel: this.fb.group({
        Name: [
          this.basketballLeague.GeneralSettingsModel.Name,
          [
            Validators.required,
        ...
        NumberOfTeams: [
          this.basketballLeague.GeneralSettingsModel.NumberOfTeams,
          [Validators.required, Validators.min(4), Validators.max(32)],
        ],
        LeagueManager: [
          this.basketballLeague.GeneralSettingsModel.LeagueManager,
        ],
        PublicLeague: [
          this.basketballLeague.GeneralSettingsModel.PublicLeague,
          [Validators.required],
        ],
        Passcode: [this.basketballLeague.GeneralSettingsModel.Passcode],
        PrimaryColor: [
          this.basketballLeague.GeneralSettingsModel.PrimaryColor,
          [Validators.required],
        ],
        SecondaryColor: [
          this.basketballLeague.GeneralSettingsModel.SecondaryColor,
          [Validators.required],
        ],
      }),
      DraftSettingsModel: this.fb.group({
        ...
        SelectionTime: [
          this.basketballLeague.DraftSettingsModel.SelectionTime,
          [Validators.required, Validators.min(10), Validators.max(300)],
        ],
        Date: [
          this.basketballLeague.DraftSettingsModel.Date,
          [Validators.required],
        ],
        IncludeBenchInDraft: [
          this.basketballLeague.DraftSettingsModel.IncludeBenchInDraft,
          [Validators.required],
        ],
      }),
      LeagueSettingsModel: this.fb.group({
        ...
        NumberOfConferences: [
          this.basketballLeague.LeagueSettingsModel.NumberOfConferences,
        ],
        TransferPortalDeadline: [
          this.basketballLeague.LeagueSettingsModel.TransferPortalDeadline,
          [Validators.required],
        ],
      }),
      ...
      SeasonModel: this.fb.group({
        RegularSeasonSettings: this.fb.group({
          ...
          HomeFieldAdvantage: [
            this.basketballLeague.SeasonModel.RegularSeasonSettings
              .HomeFieldAdvantage,
            [Validators.required],
          ],
        ...
        PlayoffSeasonSettings: this.fb.group({
          ...
          SeedingType: [
            this.basketballLeague.SeasonModel.PlayoffSeasonSettings.SeedingType,
            [Validators.required],
          ],
          TieBreakerType: [
            this.basketballLeague.SeasonModel.PlayoffSeasonSettings
              .TieBreakerType,
          ],
        }),
      }),
